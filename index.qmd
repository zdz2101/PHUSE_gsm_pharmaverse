...
-   Raw → SDTM ([gsm + sdtm.oak](gsm_SDTM_example.qmd)): Raw data were transformed into SDTM using gsm workflows, following a pre-existing sdtm.oak example for the VS domain as a reference implementation. An example can be found [here.
